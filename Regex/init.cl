...
// init file for module Regex
// created Fri Sep 10 14:53:27 2004 by claire v3.3.33



Regex :: module(
	uses = list(Core),
	made_of = list("model.cl", "<regex.h>"),
	source = "source",
...
(Generate/C++PRODUCER.Generate/bad_names :add Regex.name)
(Generate/C++PRODUCER.Generate/good_names :add symbol!("clRegex",claire))
