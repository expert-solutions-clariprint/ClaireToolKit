...
[claire/session_exists?(self:session_storage,session_id:string) : boolean -> false]
...
[claire/session_exists?(self:session_default_file_storage,session_id:string) : boolean -> isfile?(session_file())]
