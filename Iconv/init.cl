...
// init file for module Iconv
// created Wed Jun  2 14:40:36 2004 by claire v3.3.33


Iconv :: module(
	uses = list(Core),
	made_of = list("model.cl", "utf8_core.h", "<iconv.h>"),
	source = "source",
...
(Generate/C++PRODUCER.Generate/bad_names :add Iconv.name)
(Generate/C++PRODUCER.Generate/good_names :add symbol!("clIconv"))
