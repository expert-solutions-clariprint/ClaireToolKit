...
// init file for module Dns
// created Wed Dec 21 10:22:39 2005 by claire v3.3.36



Dns :: module(
	uses = list(Core),
	made_of = list("model.cl", "<resolv.h>", "<arpa/nameser.h>", "<arpa/nameser_compat.h>"),
	source = "source",
...
(if (find(compiler.env,"Darwin") > 0) 
	compiler.libraries :add "-lresolv"
else compiler.libraries :add "-lbind")
