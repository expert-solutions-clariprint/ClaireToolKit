...
[_filter_pdf_string(self:string) : void ->
	//[0] filter_pdf_string(~S) // self,
	princ(Iconv/iconv(self,"UTF-16BE","UTF-8"))]

[filter_pdf_string(self:string) : void ->
	if (UTF8_MODE) princ(Iconv/iconv(self,"UTF-16BE","UTF-8"))
	else for i in (1 .. length(self))
		let c := self[i]
