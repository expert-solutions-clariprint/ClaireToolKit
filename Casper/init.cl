...
// init file for module Casper
// created Wed Oct  1 14:04:32 2003 by claire v3.3.29

(use_module("Wcl"))

Casper :: module(
	uses = list(Wcl),
//	made_of = list("server.cl", "<pwd.h>"),
	made_of = list("main.cl", "<pwd.h>"),
	source = "source",
...
// ==== C++ compiler options ====
;(compiler.options[1] :/+ "-cpp_otion") // Optimize mode (-O)
;(compiler.options[2] :/+ "-cpp_otion") // Debug mode (-D)
;(compiler.options[3] :/+ "-cpp_otion") // Release mode
